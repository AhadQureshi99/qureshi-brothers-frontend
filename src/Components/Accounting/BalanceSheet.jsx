...
const BalanceSheet = () => {
  ...
  const loadBalanceSheet = async () => {
    ...
    try {
      ...
      const res = await axios.get("/api/accounting/reports/balance-sheet", {
        headers: { Authorization: `Bearer ${token}` },
        params,
      });
      setBalanceSheet(res.data.balanceSheet || {});
    } catch (err) {
      console.error("Load balance sheet error", err);
                  ...
                  <>
                    <tr className="hover:bg-gray-50">
                      ...
                      <td className="border border-gray-300 px-4 py-2">
                        {balanceSheet.assets?.toFixed(2) || "0.00"}
                      </td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="border border-gray-300 px-4 py-2 font-semibold">
                      ...
                      <td className="border border-gray-300 px-4 py-2">
                        {balanceSheet.liabilities?.toFixed(2) || "0.00"}
                      </td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="border border-gray-300 px-4 py-2 font-semibold">
                      ...
                      <td className="border border-gray-300 px-4 py-2">
                        {balanceSheet.equity?.toFixed(2) || "0.00"}
                      </td>
                    </tr>
