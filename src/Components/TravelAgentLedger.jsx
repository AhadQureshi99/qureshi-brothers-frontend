...
const TravelAgentLedger = () => {
  ...
  const loadTravelAgentLedger = async () => {
    ...
    try {
      ...
      console.error("Load travel agent ledger error", err);
      toast.error("Failed to load travel agent ledger");
    } finally {
      setLoading(false);
    }
  };
...
export default TravelAgentLedger;
