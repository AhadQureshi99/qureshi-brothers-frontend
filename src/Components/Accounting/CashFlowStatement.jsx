...
const CashFlowStatement = () => {
  ...
  const loadCashFlowStatement = async () => {
    ...
    try {
      ...
      setCashFlowStatement(res.data.cashFlowStatement || {});
    } catch (err) {
      console.error("Load cash flow statement error", err);
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          {loading ? (
            ...
            <table className="w-full table-auto border-collapse">
              ...
              <tbody>
                {cashFlowStatement.operatingCashFlow !== undefined ? (
                  <>
                    <tr className="hover:bg-gray-50">
                      ...
                      <td className="border border-gray-300 px-4 py-2">
                        {cashFlowStatement.operatingCashFlow?.toFixed(2) ||
                          "0.00"}
                      </td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      ...
                      <td className="border border-gray-300 px-4 py-2">
                        {cashFlowStatement.investingCashFlow?.toFixed(2) ||
                          "0.00"}
                      </td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      ...
                      <td className="border border-gray-300 px-4 py-2">
                        {cashFlowStatement.financingCashFlow?.toFixed(2) ||
                          "0.00"}
                      </td>
                    </tr>
                    <tr className="hover:bg-gray-50 font-bold">
                      ...
                      <td className="border border-gray-300 px-4 py-2">
                        {cashFlowStatement.netCashFlow?.toFixed(2) || "0.00"}
                      </td>
                    </tr>
                  </>
                ) : (
