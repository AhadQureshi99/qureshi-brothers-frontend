...
const JournalVoucher = () => {
  ...
  const [entries, setEntries] = useState([
    { code: "", name: "", description: "", debit: "", credit: "" },
  ]);
  ...
  const loadAccounts = async () => {
    try {
      const token =
        ...
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY4ZWY0NGNhNzQ3YWJmYjA5OGZlYjRjZSIsImVtYWlsIjoiYWhhZHF1cmVzaGkxNjc1NkBnbWFpbC5jb20iLCJ1c2VybmFtZSI6ImFoYWQiLCJyb2xlIjoic3VwZXJhZG1pbiIsImlhdCI6MTc2MTY1MDc3MCwiZXhwIjoxNzYyOTQ2NzcwfQ.pvJJRM4tl11bR6Qw6arXiu-tLlYYrwWJuPjzb_7h33E";
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-sm text-gray-600">Add/Edit Journal Voucher</p>
          </div>
