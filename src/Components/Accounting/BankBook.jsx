...
const BankBook = () => {
  ...
  const loadBankBook = async () => {
    ...
    try {
      ...
      const res = await axios.get("/api/accounting/reports/bank-book", {
        headers: { Authorization: `Bearer ${token}` },
        params,
      });
      setBankBookData(res.data.bankBook || []);
    } catch (err) {
      console.error("Load bank book error", err);
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          {loading ? (
            <div className="p-8 text-center">
              <div className="text-gray-500">Loading bank book...</div>
            </div>
          ) : (
                ...
                <tbody>
                  {bankBookData.length > 0 ? (
                    ...
                    <tr>
                      ...
                      >
                        No bank book data found. Please adjust filters and view
                        report.
                      </td>
                    </tr>
                  )}
